...
namespace AG
{
    public class DSLanguageAudioClipFieldCallbacks : DSFieldCallbacksBase
    {
        /// <summary>
        ...
        /// </summary>
        /// <param name="LG_AudioClipContainer">The LG object container of which the field is connecting to.</param>
