...
namespace AG
{
    public class DSNodeTitleFieldEventRegister : DSFieldEventRegisterBase
    {
        /// <summary>
        ...
        /// </summary>
        /// <param name="textContainer">Text container of which the node title field is connecting to.</param>
        public static void RegisterNodeTitleChangedEvent(TextContainer textContainer)
        {
            ...
            nodeTitleField.RegisterValueChangedCallback(value =>
            {
        ...
        public static void RegisterNodeTitleFocusInEvent(TextContainer textContainer)
        {
            ...
            nodeTitleField.RegisterCallback<FocusInEvent>(value =>
            {
                ...
                nodeTitleField.GetTextFieldInputBase().pickingMode = PickingMode.Position;
            });
        }
        ...
        public static void RegisterNodeTitleFocusOutEvent(TextContainer textContainer)
        {
            ...
            nodeTitleField.RegisterCallback<FocusOutEvent>(value =>
            {
