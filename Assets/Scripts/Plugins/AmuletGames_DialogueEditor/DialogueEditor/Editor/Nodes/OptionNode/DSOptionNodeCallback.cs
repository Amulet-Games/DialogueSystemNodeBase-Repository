...
namespace AG
{
    public class DSOptionNodeCallback : DSNodeCallbackFrameBase<
        DSOptionNode,
        DSOptionNodeModel,
    ...
    >
    {
        ...
        public DSOptionNodeCallback
        (
            DSOptionNode node,
            DSOptionNodeModel model,
            DSOptionNodeSerializer serializer
        )
        {
            Node = node;
            Model = model;
        ...
        public override void DelayedManualCreatedAction()
        {
            ...
            void CheckIsOptionChannelCreation()
            {
                ...
                {
                    Model.OptionTrack.NodeDelayedManualCreatedAction(Details.ConnectorPort);
                }
                else
                {
        ...
        public override void CommonDelayedCreatedAction()
        {
            ...
            {
                Node.style.minWidth = DSNodesConfig.OptionNodeMinWidth;
            }

            void SetMaxWidthProperties()
            {
                // Node
                Node.style.maxWidth = DSNodesConfig.OptionNodeMinWidth + DSNodesConfig.OptionNodeMaxWidthBuffer;
                ...
                void GeometryChangedAction(GeometryChangedEvent evt)
                {
                    ...
                    nodeTitleField.style.maxWidth = nodeTitleField.contentRect.width + DSNodesConfig.OptionNodeMaxWidthBuffer;
        ...
        {
            DisconnectOptionTrack();

            DisconnecOutputPort();

            void DisconnectOptionTrack()
            {
                Model.OptionTrack.NodePreManualRemovedAction();
            }
        ...
        protected override void LanguageChangedAction()
        {
            ...
            void ReloadLanguage()
            {
                Model.OptionHeaderTextContainer.ReloadLanguage();
            }
        }
    }
}