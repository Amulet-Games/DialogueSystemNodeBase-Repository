...
namespace AG
{
    public class DSEventNodeCallback : DSNodeCallbackFrameBase<
        DSEventNode,
        DSEventNodeModel,
    ...
    >
    {
        ...
        public DSEventNodeCallback
        (
            DSEventNode node,
            DSEventNodeModel model,
            DSEventNodeSerializer serializer
        )
        {
            Node = node;
            Model = model;
        ...
        public override void CommonDelayedCreatedAction()
        {
            ...
            {
                Node.style.minWidth = DSNodesConfig.EventNodeMinWidth;
            }

            void SetMaxWidthProperties()
            {
                // Node
                Node.style.maxWidth = DSNodesConfig.EventNodeMinWidth + DSNodesConfig.EventNodeMaxWidthBuffer;
                ...
                void GeometryChangedAction(GeometryChangedEvent evt)
                {
                    ...
                    nodeTitleField.style.maxWidth = nodeTitleField.contentRect.width + DSNodesConfig.EventNodeMaxWidthBuffer;
