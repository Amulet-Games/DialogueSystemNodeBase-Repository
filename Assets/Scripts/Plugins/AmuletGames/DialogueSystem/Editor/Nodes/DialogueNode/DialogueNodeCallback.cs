...
namespace AG.DS
{
    ...
    >
    {
        ...
        protected override void SetNodeMinMaxWidth()
        {
            ...
            {
                Node.style.minWidth = NodesConfig.DialogueNodeMinWidth;
            }
            ...
            void SetMaxWidthProperties()
            {
                // Node
                Node.style.maxWidth =
                    NodesConfig.DialogueNodeMinWidth + NodesConfig.DialogueNodeMaxWidthBuffer;
                ...
                void GeometryChangedAction(GeometryChangedEvent evt)
                {
                    ...
                    nodeTitleField.style.maxWidth =
                        nodeTitleField.contentRect.width + NodesConfig.DialogueNodeMaxWidthBuffer;
