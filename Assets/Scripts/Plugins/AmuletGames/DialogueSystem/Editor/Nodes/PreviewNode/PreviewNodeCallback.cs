...
namespace AG.DS
{
    ...
    >
    {
        ...
        protected override void SetNodeMinMaxWidth()
        {
            ...
            {
                Node.style.minWidth = NodesConfig.PreviewNodeMinWidth;
            }
            ...
            void SetMaxWidthProperties()
            {
                // Node
                Node.style.maxWidth =
                    NodesConfig.PreviewNodeMinWidth + NodesConfig.PreviewNodeMaxWidthBuffer;
                ...
                void GeometryChangedAction(GeometryChangedEvent evt)
                {
                    ...
                    nodeTitleField.style.maxWidth =
                        nodeTitleField.contentRect.width + NodesConfig.PreviewNodeMaxWidthBuffer;
