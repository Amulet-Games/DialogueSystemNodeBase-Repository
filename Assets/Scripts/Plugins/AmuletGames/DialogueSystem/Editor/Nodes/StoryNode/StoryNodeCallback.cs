...
namespace AG.DS
{
    ...
    >
    {
        ...
        protected override void SetNodeMinMaxWidth()
        {
            ...
            {
                Node.style.minWidth = NodesConfig.StoryNodeMinWidth;
            }
            ...
            void SetMaxWidthProperties()
            {
                // Node
                Node.style.maxWidth =
                    NodesConfig.StoryNodeMinWidth + NodesConfig.StoryNodeMaxWidthBuffer;
                ...
                void GeometryChangedAction(GeometryChangedEvent evt)
                {
                    ...
                    nodeTitleField.style.maxWidth =
                        nodeTitleField.contentRect.width + NodesConfig.StoryNodeMaxWidthBuffer;
