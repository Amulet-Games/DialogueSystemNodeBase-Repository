...
namespace AG.DS
{
    public class GraphTitleChangedEvent
    {
        /// <summary>
        /// GraphTitleChangedEvent, which'll be invoked when the graph's title is changed to a new one
        ...
        public static void Register(HeadBar headBar)
        {
