...
namespace AG.DS
{
    ...
    public class ConditionModifierViewObserver
    {
        ...
        /// Reference of the condition modifier search tree entry provider.
        /// </summary>
        ConditionModifierViewSearchTreeEntryProvider conditionModifierSearchTreeEntryProvider;


        /// <summary>
        /// Reference of the condition modifier view group view.
        /// </summary>
        ...
        /// <param name="conditionModifierSearchTreeEntryProvider">The condition modifier search tree entry provider to set for.</param>
        ...
        {
            this.view = view;
            this.conditionModifierSearchTreeEntryProvider = conditionModifierSearchTreeEntryProvider;
        ...
        void RegisterFirstVariableGroupEvents()
            => new VariableGroupObserver(
                group: view.FirstVariableGroup, conditionModifierSearchTreeEntryProvider).RegisterEvents();
        ...
        void RegisterSecondVariableGroupEvents()
            => new VariableGroupObserver(
                group: view.SecondVariableGroup, conditionModifierSearchTreeEntryProvider).RegisterEvents();
